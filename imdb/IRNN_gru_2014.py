...
from src.utils import load_imdb, init_constant, init_diagnal, shared_dataset
...
train_set, valid_set, test_set = load_imdb('../data/imdb.pkl',maxlen=max_len)
...
f=open('./result/2014_100.csv','w',0)
...
for epoch in range(num_epochs):
    ...
    if epoch % valid_feq == 0 and epoch > 0:
        f.write("  validation loss:\t\t{:.6f}".format(val_err / val_batches))
